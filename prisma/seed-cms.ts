...
// ---------------------------------------------------------------------------
// Helper: clear existing CMS data
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Define all CMS sections (structure only)
// ---------------------------------------------------------------------------
...
async function seedContents(tx: PrismaTransaction = prisma) {
  ...
  // Helper to create content for a given section
  ...
  // ===== program_features (list) =====
  await createContent(
    'sec_program_features', 1,
    'Career Prospect',
    'Information System Specialist, Data Scientist, Data Analyst, Business Intelligence Developer, Database Developer, Database Administration, ERP Consultant, ERP System Developer, Researcher, Technopreneur, Academia',
    IMAGE
  );
  await createContent(
    'sec_program_features', 2,
    'Advanced Study',
    'Graduates of the Information System Study Program can pursue master\'s degrees in a variety fields of Information Technology or Computer Science.',
    IMAGE
  );
  await createContent(
    'sec_program_features', 3,
    'Superiority',
    'To produce graduates capable of analyzing, designing, implementing, and managing data-based information systems that meet business needs as well as support future decision-making for an organization\'s strategic development plan',
    IMAGE
  );
  await createContent(
    'sec_program_features', 4,
    'Requirements',
    'High School graduates majoring in Science and Social Sciences , Vocational High School graduates majoring in Computer Engineering, Informatics Engineering, Computer and Network Engineering.',
    IMAGE
  );

  // ===== specialization_overview (single) =====
  await createContent(
    'sec_specialization_overview', 1,
    'Specialization Track',
    'Information System Study Program offers three specialization tracks from which students can choose in semester 3 and 4 based on their preferences',
    null
  );

  // ===== vision_mission (content) =====
  await createContent(
    'sec_vision_mission', 1,
    'Mission',
    '1. Organizing a quality learning process supported by professional teaching staff and an up-to-date curriculum to produce graduates who are competent in analysis, design, implementation, and management of big data-based information systems, have an entrepreneurial spirit, noble character, and international insight.\n2. Carrying out international standards research programs in collaboration with various, disciplines and industries related to big data-based information systems.\n3. Carrying out community service activities that provide appropriate contributions in the field of big data-based information systems.',
    null
  );
  await createContent(
    'sec_vision_mission', 2,
    'Vision',
    'Becoming an excellent Information Systems Undergraduate Study Program that produce graduates who are competent in the field of analysis, design, implementation, and management of big data-based information systems, have an entrepreneurial spirit, noble character, and international insight.',
    null
  );
  ...
  await createContent(
    'sec_history', 3,
    '2017',
    'Since the 2020/2021 academic year, the Information Systems study program uses the outcome based education (OBE) curriculum, then by the government regulations, in 2021 the curriculum was revised and updated to become an “Merdeka Belajar Kampus Merdeka” (MBKM) curriculum so that starting in the 2021/2022 academic year, the Information Systems study program implement the MBKM curriculum.',
    IMAGE
  );

  // ===== graduate_profiles (list) =====
  await createContent(
    'sec_graduate_profiles', 1,
    'GP01 (IS Enabler)',
    'Graduates have the ability to analyze, design, create, and evaluate information systems that are aligned with the organizational goals.',
    null
  );
  await createContent(
    'sec_graduate_profiles', 2,
    'GP02 (IS Solution)',
    'Graduates have the ability to understand, implement, and integrate the system models, use various methods and techniques of business process improvement that bring value to the organization.',
    null
  );
  await createContent(
    'sec_graduate_profiles', 3,
    'GP03 (Data Analytics)',
    'Graduates have the ability to extract, investigate and interpret data so that it becomes valuable and easy-to-understand information.',
    null
  );
  await createContent(
    'sec_graduate_profiles', 4,
    'GP04 (Technopreneurship)',
    'Graduates have the ability to collaborate with various disciplines to produce a business idea related to the latest information technology.',
    null
  );
  ...
  // ===== career_prospect (single) =====
  await createContent(
    'sec_career_prospect', 1,
    'Career Prospect',
  ...
  await createContent(
    'sec_partners', 1,
    'SAP VICTORIA',
    'We collaborate with SAP Victoria University to provide learning material and SAP platform for students in specialization track of ERP specialist.',
    IMAGE
  );
  await createContent(
    'sec_partners', 2,
    'Oracle Academy',
    'We collaborate with the oracle academy to provide learning material for students in specialization track of database specialist.',
    IMAGE
  );
  await createContent(
    'sec_partners', 3,
    'Cybertrend Data',
    'We collaborate with Cybertrend Data Academy to provide learning material and international certification program for students especially for data modeling certification and data visualization certification.',
    IMAGE
  );

  // ===== admission_requirements (content) =====
  await createContent(
    'sec_admission_requirements', 1,
    'Application Channels',
    'Academic channel, where students are filtered based on their high school report card with particular emphasis on specific subjects, according to the programme they apply to.\nScholarship channel. Applicants are filtered based on their high school achievements, ranging from academic to non-academic achievements.\nRegular test channel. Applicants take part in written tests according to the programme they apply to and are awarded admission upon passing.\nRegular and Scholarship test channel. Applicants take part in written tests according to the programme they are applying to and are awarded admission and scholarship based on the test score.',
    null
  );
  await createContent(
    'sec_admission_requirements', 2,
    'Specific Application Requirements',
    'The specific requirements help us ensure the applicants possess sufficient basic knowledge to follow the curriculum and graduate on time.\nSchool origin: High School (SMA) graduates of natural science (IPA) track and social science (IPS) track\nEmphasised subjects in school report: English, Mathematics, IT\nWritten test subjects (scholarship): English, Logics, Basic Mathematics and Statistics',
    null
  );

  // ===== specialization_list (list) =====
  await createContent(
    'sec_specialization_list', 1,
    'Database Specialist',
